...
public class ElementalsFree : MonoBehaviour
{
    private readonly string[] m_animations = { "Attack", "Damaged", "Dead", "Reset" };
    private Animator[] m_animators;
    [SerializeField] private ElementalsCameraLogic m_cameraLogic;
